  ...
  <div class="container">
    ...
    <div class="left">
      ...
      <div class="name">
        ...
        <div class="prof">Фронтенд розробник</div>
      </div>

      <div class="info">
        <div class="title">
          <div class="img"></div>
          <div class="left_title">Загальна інформація</div>
        </div>
        <div class="content">
          <div class="personal">
            <div class="inf">
              Адреса: 
              <div class="val"> Україна, Київ</div>
            </div>
            
            <div class="inf">Англійська:
              <div class="val">Intermediate</div>
            </div>
            <div class="inf">
              Досвід: 
              <div class="val"> 6 років</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="contact">
        <div class="title">
          <div class="img"></div>
          <div class="left_title">Контактна інформація</div>
        </div>
        ...
        <div class="content">
          <div class="cont_items">
            <!-- <div class="cont_item">
              <div class="img"></div>
              <span>Kiyv Nekhody 5, 03815</span>
            </div> -->
            <div class="cont_item">
              <div class="img2"></div>
              <span>+38 (063) 545-74-50</span>
            </div>
            <div class="cont_item">
              <div class="img3"></div>
              <span>litvinovskiyv@gmail.com</span>
            </div>
          </div>
        </div>
    ...
    <div class="right">
      ...
      <div class="leng_wrap">
        <div class="lang">
          ...
          <div class="separ">|</div>
          <router-link class="ua" to="/ua">UA</router-link>
        </div>
      </div>
      ...
      <div class="edu">
        ...
        <div class="college">
          ...
          <div class="func">Створення адаптивного макету корпоративного сайту, оптимізація та розширення функціональності коду, односторінкові додатки</div>
        </div>
        <div class="college">
          <div class="year">2017 - 2020</div>
          <div class="name">Інвест-Ком</div>
          <div class="func">Розробка додатків та сервісів. Участь у розробці CRM системи</div>
        </div>
        <div class="college">
          <div class="year">2020 - 2024</div>
          <div class="name">Регіональна газова    компанія</div>
          <div class="func">Створення веб-сайтів для маркетплейсів, інтернет-магазину, CRM систем та веб-сайтів калькуляторів</div>
        </div>
      </div>

      <div class="skill">
        <div class="title">Навички програмування</div>
        <div class="skills">
          ...
          <div class="item">
            ...
            <div class="pers">95%</div>
          </div>

          <div class="item">
            <div class="title">Vue.js (VueEx)</div>
            <div class="line">
              <div class="progress" style="width: 90%;"></div>
            </div>
            <div class="pers">90%</div>
          </div>

          <div class="item">
            <div class="title">Nuxt.js (SSR, SEO)</div>
            <div class="line">
              <div class="progress" style="width: 85%;"></div>
            </div>
            <div class="pers">85%</div>
          </div>
          ...
          <div class="item">
            <div class="title">UI/UX (Element, BS)</div>
            <div class="line">
              <div class="progress" style="width: 95%;"></div>
            </div>
            <div class="pers">95%</div>
      ...
      <div class="experiance2">
        <div class="title">Додаткові навички</div>
        <ul>
          <li>Проведення конференцій</li>
          <li>Кодрев'ю</li>
          <li>Оптимізація процесів</li>
          <li>Тестування додатків</li>
          <!-- <li>Проведення інтерв'ю</li> -->
        </ul>
      </div>
      <div class="portfolio">
  ...
  .left {
    ...
    .info {
      ...
      .title {
        ...
        .img {
          ...
          mask: url(@/assets/inf.svg) no-repeat center;
    ...
    .contact {
      .title {
        ...
        .img {
          ...
          height: 55px;
          background-color: white;
          mask: url(@/assets/cont.svg) no-repeat center;
          mask-size: cover !important;
        }
        .left_title {
          margin-left: 15px;
        ...
        .cont_items {
          ...
          .cont_item {
            ...
            .img2 {
              ...
              margin-right: 15px;
              background-color: white;
              mask: url(@/assets/phone.svg) no-repeat center;
              mask-size: cover !important;
            }
            .img3 {
              width: 24px;
    ...
    .social {
      ...
      .img {
        ...
        margin-right: 15px;
        background-color: white;
        mask: url(@/assets/0.svg) no-repeat center;
        mask-size: cover !important;
      }
      .img2 {
        width: 40px;
        ...
        margin-right: 15px;
        background-color: white;
        mask: url(@/assets/1.svg) no-repeat center;
        mask-size: cover !important;
      }
      .img3 {
        width: 40px;
        ...
        margin-right: 15px;
        background-color: white;
        mask: url(@/assets/2.svg) no-repeat center;
        mask-size: cover !important;
      }
    }
  }
